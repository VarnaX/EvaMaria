...
def required_var(var_name, is_int=False):
    try:
        ...
        print('One or more int type env variables missing! Exiting now')
        exit(1)

# Bot information
API_ID = required_var('API_ID',True)
API_HASH = required_var('API_HASH')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in required_var('ADMINS').split()]
...
# MongoDB information
DATABASE_URI = required_var('DATABASE_URI')
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = required_var('LOG_CHANNEL',True)
